...
RULES:
1. MUST be for searching people/attorneys/lawyers by name (not site search)
2. PREFER inputs with "name", "keyword", "people", "attorney", "lawyer" in placeholder/label
3. STRONGLY AVOID inputs with in_header=True (those are usually site-wide search)
4. AVOID inputs that filter by location, practice area, or other non-name criteria
